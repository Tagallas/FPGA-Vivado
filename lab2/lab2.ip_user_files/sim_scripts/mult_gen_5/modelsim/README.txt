...
#
# Generated by export_simulation on Sat Mar 23 09:23:55 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './mult_gen_5.sh' script.

./mult_gen_5.sh -reset_run
...
./mult_gen_5.sh -noclean_files

For more information on the script, please type './mult_gen_5.sh -help'.
