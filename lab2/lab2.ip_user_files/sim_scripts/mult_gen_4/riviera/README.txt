...
#
# Generated by export_simulation on Fri Mar 22 20:51:22 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './mult_gen_4.sh' script.

./mult_gen_4.sh -reset_run
...
./mult_gen_4.sh -noclean_files

For more information on the script, please type './mult_gen_4.sh -help'.
