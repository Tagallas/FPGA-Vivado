...
HD_PWD='C:/Users/wojte/Desktop/Systemy Rekonfigurowalne/lab2/lab2.runs/mult_gen_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_4.tcl
