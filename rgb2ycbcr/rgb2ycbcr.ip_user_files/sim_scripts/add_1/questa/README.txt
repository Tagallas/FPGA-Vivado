...
#
# Generated by export_simulation on Sat Apr 27 18:20:14 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './add_1.sh' script.
...
./add_1.sh -noclean_files

For more information on the script, please type './add_1.sh -help'.
