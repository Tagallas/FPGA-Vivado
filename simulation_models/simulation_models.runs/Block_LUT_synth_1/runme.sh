...
HD_PWD='C:/Users/wojte/Desktop/SystemyRekonfigurowalne/simulation_models/simulation_models.runs/Block_LUT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_LUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_LUT.tcl
